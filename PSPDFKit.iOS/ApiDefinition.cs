...
namespace PSPDFKit.iOS {
	...
	interface PSPDFDocumentSharingCoordinator : PSPDFDocumentSharingViewControllerDelegate {
		...
		NSOrderedSet /*<NSNumber>*/ VisiblePages { get; set; }
	...
	interface PSPDFPageControls {
		...
		bool SetPage (nuint page, [NullAllowed] NSDictionary<NSString, NSNumber> options, bool animated);
	...
	interface PSPDFVisiblePagesDataSource {
		...
		NSOrderedSet VisiblePagesCalculated { get; }
	}
	...
	interface PSPDFPresentationActions {
		...
		void PresentViewController (UIViewController viewController, [NullAllowed] NSDictionary<NSString, NSObject> options, bool animated, [NullAllowed] NSObject sender, [NullAllowed] Action completion);
		...
		[Export ("sender:shouldShowController:options:animated:")]
		bool ShouldShowController (NSObject sender, UIViewController controller, [NullAllowed] NSDictionary<NSString, NSObject> options, bool animated);
	}
	...
	IMFMessageComposeViewControllerDelegate {
		...
		NSOrderedSet /*<NSNumber>*/ VisiblePages { get; }
		...
		[Export ("presentViewController:options:animated:sender:completion:")]
		void PresentViewController (UIViewController controller, [NullAllowed] NSDictionary<NSString, NSObject> options, bool animated, [NullAllowed] NSObject sender, [NullAllowed] Action completion);
		...
		void PresentPreviewController (NSUrl fileUrl, string title, [NullAllowed] NSDictionary<NSString, NSObject> options, [NullAllowed] NSObject sender, bool animated, [NullAllowed] Action completion);
	...
	interface PSPDFDocument  {
		...
		IntPtr Constructor (NSObject content, [NullAllowed] NSData [] signatures);
		...
		PSPDFPageInfo GetPageInfo (nuint page);

		[Export ("nearestPageInfoForPage:")]
		[return: NullAllowed]
		PSPDFPageInfo GetNearestPageInfo (nuint page);
		...
		NSOrderedSet /*<NSString>*/ EditableAnnotationTypes { get; set; }
		...
		[return: NullAllowed]
		UIImage ImageForPage (nuint page, CGSize size, CGRect clipRect, [NullAllowed] PSPDFAnnotation [] annotations, [NullAllowed] NSDictionary<NSString, NSObject> options, out PSPDFRenderReceipt receipt, out NSError error);

		[Export ("renderPage:context:size:clippedToRect:annotations:options:error:")]
		[return: NullAllowed]
		PSPDFRenderReceipt RenderPage (nuint page, CGContext context, CGSize size, CGRect clipRect, [NullAllowed] PSPDFAnnotation [] annotations, [NullAllowed] NSDictionary<NSString, NSObject> options, out NSError error);

		[Export ("renderOptions", ArgumentSemantic.Copy)]
		NSDictionary<NSString, NSObject> RenderOptions { get; set; }
		...
		NSDictionary AnnotationsFromDetectingLinkTypes (PSPDFTextCheckingType textLinkTypes, NSIndexSet pageRange, [NullAllowed] NSDictionary<NSString, NSDictionary<NSNumber, NSArray /*<PSPDFAnnotation>*/>> options, [NullAllowed] PSPDFDocumentDetectingLinkTypesHandler progressHandler, out NSError error);
		...
		NSDictionary<NSString, NSObject> ObjectsAtPdfPoint (CGPoint pdfPoint, nuint page, NSDictionary<NSString, NSNumber> options);

		[Export ("objectsAtPDFRect:page:options:")]
		NSDictionary<NSString, NSObject> ObjectsAtPdfRect (CGRect pdfRect, nuint page, NSDictionary<NSString, NSNumber> options);
	}
	...
	interface PSPDFDocumentDelegate	{
		...
		void DidRenderPage (PSPDFDocument document, nuint page, CGContext context, CGSize fullSize, CGRect clipRect, [NullAllowed] PSPDFAnnotation [] annotations, [NullAllowed] NSDictionary<NSString, NSObject> options);
	...
	interface PSPDFPresentationContext : PSPDFOverridable, PSPDFVisiblePagesDataSource, PSPDFErrorHandler {
		...
		[Abstract]
		[Export ("displayingViewController"), NullAllowed]
		...
		PSPDFPageView [] VisiblePageViewsForcingLayout (bool forcingLayout);
	...
	interface PSPDFDiskCache {
		...
		void StoreImage (UIImage image, string uid, nuint page, Func<UIImage, NSData> encryptionHelper, string renderReceipt, [NullAllowed] Action<NSObject> completionBlock);
	...
	interface PSPDFPageInfo {
		...
		[Export ("initWithPage:rect:rotation:additionalActions:documentProvider:")]
		[DesignatedInitializer]
		IntPtr Constructor (nuint page, CGRect pageRect, nint rotation, [NullAllowed] NSDictionary<NSNumber, PSPDFAction> additionalActions, [NullAllowed] PSPDFDocumentProvider documentProvider);
		...
		[Export ("rectZeroOffset")]
		CGRect RectZeroOffset { get; }
		...
		[Export ("rotatedRectZeroOffset")]
		CGRect RotatedRectZeroOffset { get; }
	...
	interface PSPDFBookmark {
		...
		[Export ("pageOrNameString"), NullAllowed]
	...
	interface PSPDFAnnotationTableViewController : PSPDFStyleable {
		...
		NSOrderedSet /*<NSString>*/ VisibleAnnotationTypes { get; set; }
		...
		UITableViewStyle TargetTableViewStyle { get; }
	...
	interface PSPDFAction : PSPDFJSONSerializing, INativeObject {
		...
		[Export ("subActions", ArgumentSemantic.Strong), NullAllowed]
	...
	interface PSPDFRichMediaExecuteAction {
		...
		IntPtr Constructor (string command, [NullAllowed] NSObject argument, [NullAllowed] PSPDFRichMediaAnnotation annotation);
	...
	interface PSPDFPageLabelView {
		...
		string PageLabel (PSPDFDocument document, nuint page, NSOrderedSet /*<NSNumber>*/ visiblePages);
	...
	interface PSPDFHUDView : PSPDFThumbnailBarDelegate, PSPDFScrubberBarDelegate, PSPDFPageLabelViewDelegate {
		...
		[Export ("showDocumentLabel", ArgumentSemantic.Assign)]
		bool ShowDocumentLabel { [Bind ("isShowingDocumentLabel")] get; set; }

		[Export ("showPageLabel", ArgumentSemantic.Assign)]
		bool ShowPageLabel { [Bind ("isShowingPageLabel")] get; set; }
	...
	interface PSPDFImageInfo {
		...
		[Export ("initWithIndex:pixelSize:transform:vertices:page:documentProvider:")]
		[DesignatedInitializer]
		IntPtr Constructor (nuint index, CGSize pixelSize, CGAffineTransform transform, CGPoint vertices, nuint page, [NullAllowed] PSPDFDocumentProvider documentProvider);
	...
	interface PSPDFScrubberBarDelegate {
		...
		[Export ("scrubberBar:didSelectPage:")]
		[Abstract]
		void DidSelectPage (PSPDFScrubberBar scrubberBar, nuint page);
	}

	[BaseType (typeof (UIView))]
	interface PSPDFScrubberBar : PSPDFCacheDelegate	{
	...
	interface PSPDFTabbedViewController {
		...
		[Export ("allowsClosingDocuments", ArgumentSemantic.Assign)]
		bool AllowsClosingDocuments { get; set; }
	...
	interface PSPDFContainerAnnotationProvider : PSPDFAnnotationProvider, PSPDFUndoProtocol {
		...
		[Export ("annotations")]
		NSDictionary<NSNumber, PSPDFAnnotation> Annotations { get; }
	...
	interface PSPDFFileAnnotationProvider {
		...
		[Export ("parseAnnotationsForPage:")]
		[return: NullAllowed]
		PSPDFAnnotation [] ParseAnnotations (nuint page);
	...
	interface PSPDFInkAnnotation {
		...
		NSArray /*<NSValue>*/ [] CopyLinesByApplyingTransform (CGAffineTransform transform);
	}
	...
	interface PSPDFAppearanceCharacteristics {
		...
		string PartialPdfString { get; }
	}

	[BaseType (typeof (PSPDFLinkAnnotation))]
	interface PSPDFAssetAnnotation : PSPDFStreamProvider {
	...
	interface PSPDFAnnotationStateManagerDelegate {
		...
		bool ShouldChangeState (PSPDFAnnotationStateManager manager, [NullAllowed] NSString state, [NullAllowed] NSString newState, [NullAllowed] NSString variant, [NullAllowed] NSString newVariant);
	...
	interface PSPDFAnnotationStateManager : PSPDFOverridable {
		...
		PSPDFAnnotationStyleViewController ShowStylePicker ([NullAllowed] NSObject sender, [NullAllowed] NSDictionary<NSString, NSObject> options);
		...
		void ToggleStampController ([NullAllowed] NSObject sender, bool includeSavedAnnotations, [NullAllowed] NSDictionary<NSString, NSObject> options);

		[Export ("toggleImagePickerController:presentationOptions:")] // Strong options PSPDFPresentationActions.h
		void ToggleImagePickerController ([NullAllowed] NSObject sender, [NullAllowed] NSDictionary<NSString, NSObject> options);
	...
	interface PSPDFAnnotationStyleViewController : PSPDFFontPickerViewControllerDelegate, PSPDFStyleable {
		...
		[Export ("propertiesForAnnotations:")]
		NSArray /*<NSString>*/ [] GetPropertiesForAnnotations (PSPDFAnnotation [] annotations);
...
//		nfloat ZoomScale { get; set; }
	...
	interface PSPDFDocumentSharingViewControllerDelegate : PSPDFOverridable {
		...
		NSDictionary<NSString, NSObject> ProcessorOptionsForDocumentSharingViewController (PSPDFDocumentSharingViewController shareController);
	...
	interface PSPDFDocumentSharingViewController : PSPDFStyleable {
		...
		IntPtr Constructor (PSPDFDocument document, [NullAllowed] NSOrderedSet /*<NSNumber>*/ visiblePages, PSPDFDocumentSharingOptions sharingOptions);
		...
		[Export ("delegateProcessorOptions"), NullAllowed]
		NSDictionary<NSString, NSObject> DelegateProcessorOptions { get; }
	}
	...
	interface PSPDFAnnotationToolbar : PSPDFAnnotationStateManagerDelegate {
		...
		PSPDFAnnotationGroup [] AnnotationGroupsOrGroupsFromEditableAnnotationTypes { get; }
	...
	interface PSPDFProcessor {
		...
		bool GeneratePdf (PSPDFDocument document, NSIndexSet [] pageRanges, NSUrl fileURL, [NullAllowed] NSMutableDictionary<NSString, NSObject> options, [NullAllowed] PSPDFProcessorProgressHandler progressHandler, out NSError error);

		[Export ("generatePDFFromDocument:pageRanges:options:progressBlock:error:")]
		NSData GeneratePdf (PSPDFDocument document, NSIndexSet [] pageRanges, [NullAllowed] NSMutableDictionary<NSString, NSObject> options, [NullAllowed] PSPDFProcessorProgressHandler progressHandler, out NSError error);

		[Export ("generatePDFFromHTMLString:outputFileURL:options:completionBlock:")]
		void GeneratePdf (string html, NSUrl fileUrl, [NullAllowed] NSMutableDictionary<NSString, NSObject> options, [NullAllowed] Action<NSError> completionHandler);

		[Export ("generatePDFFromHTMLString:options:completionBlock:")]
		void GeneratePdf (string html, [NullAllowed] NSMutableDictionary<NSString, NSObject> options, [NullAllowed] PSPDFProcessorPdfFromUrlNsdataHandler completionHandler);

		[Export ("generatePDFFromURL:outputFileURL:options:completionBlock:")]
		PSPDFConversionOperation GeneratePdf (NSUrl inputUrl, NSUrl outputUrl, [NullAllowed] NSMutableDictionary<NSString, NSObject> options, [NullAllowed] PSPDFProcessorPdfFromUrlHandler completionHandler);

		[Export ("generatePDFFromURL:options:completionBlock:")]
		PSPDFConversionOperation GeneratePdf (NSUrl inputUrl, [NullAllowed] NSMutableDictionary<NSString, NSObject> options, [NullAllowed] PSPDFProcessorPdfFromUrlNsdataHandler completionHandler);
	}
	...
	interface PSPDFDataProvider : INSSecureCoding {
		...
		[Export ("createDataSinkWithOptions:")]
		IPSPDFDataSink CreateDataSink (PSPDFDataSinkOptions options);
	...
	interface PSPDFButtonFormElement {
		...
		[Export ("pushButton")]
		bool PushButton { [Bind ("isPushButton")] get; }

		[Export ("checkBox")]
		bool CheckBox { [Bind ("isCheckBox")] get; }

		[Export ("radioButton")]
		bool RadioButton { [Bind ("isRadioButton")] get; }
	...
	interface PSPDFChoiceFormElement {
		...
		[Export ("combo")]
		bool Combo { [Bind ("isCombo")] get; }

		[Export ("edit")]
		bool Edit { [Bind ("isEdit")] get; }

		[Export ("multiSelect")]
		bool MultiSelect { [Bind ("isMultiSelect")] get; }
	...
	interface PSPDFGalleryViewController : PSPDFOverridable {
		...
		[DesignatedInitializer]
		IntPtr Constructor (NSObject pluginRegistry, [NullAllowed] NSDictionary<NSString, NSObject> options);
	...
	interface PSPDFStylusManager {
		...
		NSOrderedSet /*<Class>*/ AvailableDriverClasses { get; }
	...
	interface PSPDFAnnotationStateManagerStylusSupport : PSPDFStylusDriverDelegate {
		...
		[Export ("annotationStateManager", ArgumentSemantic.Weak), NullAllowed]
		PSPDFAnnotationStateManager AnnotationStateManager { get; }

		// PSPDFAnnotationStateManager (StylusSupport) Category

		[Export ("stylusSupport", ArgumentSemantic.Strong)]
		PSPDFAnnotationStateManagerStylusSupport StylusSupport { get; }

		[Export ("stylusStatusButton", ArgumentSemantic.Strong)]
		PSPDFToolbarButton StylusStatusButton { get; }
	}
