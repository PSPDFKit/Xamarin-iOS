...
namespace PSPDFKit.Core {
	...
	interface PSPDFAnnotationStyleManager {
		...
		[Export ("stylesForKey:")]
		[return: NullAllowed]
		PSPDFAnnotationStyle [] GetStyles (string key);
		...
		[return: NullAllowed]
		PSPDFAnnotationStyle GetLastUsedStyle (string key);

		[Abstract]
		[Export ("lastUsedProperty:forKey:")]
		[return: NullAllowed]
		NSObject GetLastUsedProperty (string styleProperty, string key);

		[Abstract]
		[Export ("setLastUsedValue:forProperty:forKey:")]
		void SetLastUsedValue ([NullAllowed] NSObject value, string styleProperty, string key);

		[Abstract]
		[Export ("defaultPresetsForKey:type:")]
		[return: NullAllowed]
		PSPDFModel [] GetDefaultPresets (string key, string type);

		[Abstract]
		[Export ("setDefaultPresets:forKey:type:")]
		void SetDefaultPresets ([NullAllowed] PSPDFModel [] presets, string key, string type);

		[Abstract]
		[Export ("presetsForKey:type:")]
		[return: NullAllowed]
		PSPDFModel [] GetPresets (string key, string type);

		[Abstract]
		[Export ("setPresets:forKey:type:")]
		void SetPresets ([NullAllowed] PSPDFModel [] presets, string key, string type);

		[Abstract]
		[Export ("isPresetModifiedAtIndex:forKey:type:")]
		bool IsPresetModified (nuint index, string key, string type);

		[Abstract]
		[Export ("resetPresetAtIndex:forKey:type:")]
		bool ResetPreset (nuint idx, string key, string type);
	}

	[Static]
	interface PSPDFStyleManagerKeys {

		[Field ("PSPDFStyleManagerLastUsedStylesKey", PSPDFKitLibraryPath.LibraryPath)]
		NSString LastUsedStylesKey { get; }

		[Field ("PSPDFStyleManagerGenericStylesKey", PSPDFKitLibraryPath.LibraryPath)]
		NSString GenericStylesKey { get; }

		[Field ("PSPDFStyleManagerColorPresetKey", PSPDFKitLibraryPath.LibraryPath)]
	...
	interface PSPDFDocumentEditorConfiguration {
		...
		[Export ("pagePatterns", ArgumentSemantic.Strong)]
		...
		[NullAllowed, Export ("selectedPagePattern", ArgumentSemantic.Strong)]
		PSPDFPagePattern SelectedPagePattern { get; set; }

		[Export ("selectedPageSize", ArgumentSemantic.Strong)]
		...
		[Export ("selectedSaveDirectory", ArgumentSemantic.Strong)]
	...
	interface PSPDFFileAnnotation {
		...
		[NullAllowed, Export ("appearanceName")]
	...
	[Static]
	interface PSPDFActionEventKeys {

		[Field ("PSPDFActionEventValueKey", PSPDFKitLibraryPath.LibraryPath)]
		NSString ValueKey { get; }

		[Field ("PSPDFActionEventNameKey", PSPDFKitLibraryPath.LibraryPath)]
		NSString NameKey { get; }

		[Field ("PSPDFActionEventTypeKey", PSPDFKitLibraryPath.LibraryPath)]
		NSString TypeKey { get; }

		[Field ("PSPDFActionEventSourceKey", PSPDFKitLibraryPath.LibraryPath)]
		NSString SourceKey { get; }

		[Field ("PSPDFActionEventTargetKey", PSPDFKitLibraryPath.LibraryPath)]
		NSString TargetKey { get; }

		[Field ("PSPDFActionEventTargetNameKey", PSPDFKitLibraryPath.LibraryPath)]
		NSString TargetNameKey { get; }

		[Field ("PSPDFActionEventRCKey", PSPDFKitLibraryPath.LibraryPath)]
		NSString RCKey { get; }

		[Field ("PSPDFActionEventChangeKey", PSPDFKitLibraryPath.LibraryPath)]
		NSString ChangeKey { get; }

		[Field ("PSPDFActionEventWillCommitKey", PSPDFKitLibraryPath.LibraryPath)]
		NSString WillCommitKey { get; }

		[Field ("PSPDFActionEventSelStartKey", PSPDFKitLibraryPath.LibraryPath)]
		NSString SelStartKey { get; }

		[Field ("PSPDFActionEventSelEndKey", PSPDFKitLibraryPath.LibraryPath)]
		NSString SelEndKey { get; }

		[Field ("PSPDFActionEventNameValueMouseDown", PSPDFKitLibraryPath.LibraryPath)]
		NSString NameValueMouseDown { get; }

		[Field ("PSPDFActionEventNameValueMouseUp", PSPDFKitLibraryPath.LibraryPath)]
		NSString NameValueMouseUp { get; }

		[Field ("PSPDFActionEventNameValueMouseEnter", PSPDFKitLibraryPath.LibraryPath)]
		NSString ValueMouseEnter { get; }

		[Field ("PSPDFActionEventNameValueMouseExit", PSPDFKitLibraryPath.LibraryPath)]
		NSString NameValueMouseExit { get; }

		[Field ("PSPDFActionEventNameValueFormat", PSPDFKitLibraryPath.LibraryPath)]
		NSString NameValueFormat { get; }

		[Field ("PSPDFActionEventNameValueCalculate", PSPDFKitLibraryPath.LibraryPath)]
		NSString NameValueCalculate { get; }

		[Field ("PSPDFActionEventNameValueValidate", PSPDFKitLibraryPath.LibraryPath)]
		NSString NameValueValidate { get; }

		[Field ("PSPDFActionEventNameValueKeystroke", PSPDFKitLibraryPath.LibraryPath)]
		NSString NameValueKeystroke { get; }

		[Field ("PSPDFActionEventNameValueBlur", PSPDFKitLibraryPath.LibraryPath)]
		NSString NameValueBlur { get; }

		[Field ("PSPDFActionEventNameValueFocus", PSPDFKitLibraryPath.LibraryPath)]
		NSString NameValueFocus { get; }

		[Field ("PSPDFActionEventTypeValueField", PSPDFKitLibraryPath.LibraryPath)]
	...
	interface PSPDFJavaScriptAction {
		...
		[return: NullAllowed]
		NSDictionary<NSString, NSObject> ExecuteScript (PSPDFDocumentProvider documentProvider, [NullAllowed] IPSPDFApplicationJSExport application, [NullAllowed] NSDictionary<NSString, NSObject> eventDictionary, [NullAllowed] NSObject sender, [NullAllowed] out NSError error);
	}

	[Category]
	[BaseType (typeof (PSPDFDocumentProvider))]
	interface PSPDFDocumentProvider_JavascriptEventsAdditions {

		[Export ("executeValueChangedJSActionSequenceWithActionContainer:application:eventParams:error:")]
		[return: NullAllowed]
		NSDictionary<NSString, NSObject> ExecuteValueChangedJSActionSequence ([NullAllowed] NSObject actionContainer, [NullAllowed] IPSPDFApplicationJSExport application, [NullAllowed] NSDictionary<NSString, NSObject> eventParams, [NullAllowed] out NSError error);

		[Export ("executeFormatActionWithActionContainer:application:eventParams:error:")]
		[return: NullAllowed]
		string ExecuteFormatAction ([NullAllowed] NSObject actionContainer, [NullAllowed] IPSPDFApplicationJSExport application, [NullAllowed] NSDictionary<NSString, NSObject> eventParams, [NullAllowed] out NSError error);

		[Export ("updateCalculatedFieldsDependingOnForm:error:")]
		bool UpdateCalculatedFields ([NullAllowed] PSPDFFormElement sourceForm, [NullAllowed] out NSError error);
	}

	interface IPSPDFApplicationJSExport { }

	[Protocol]
	interface PSPDFApplicationJSExport {

		[Abstract]
		[Export ("pageNum")]
		nuint PageNum { get; set; }

		[Abstract]
		[Export ("getField:")]
		[return: NullAllowed]
		NSObject GetField (string name);

		[Abstract]
		[Export ("getNthFieldName:")]
		[return: NullAllowed]
		string GetNthFieldName (nuint index);
		...
		[Abstract]
		[Export ("resetForm:")]
		void ResetForm (string [] names);

		[Abstract]
		[Export ("alert:")]
		void Alert (NSObject @params);

		[Abstract]
		[Export ("viewerVersion")]
		nuint ViewerVersion { get; }

		[Export ("buttonImportIcon:page:sourceForm:__JS_EXPORT_AS__buttonImportIcon:")]
		nint GetButtonImportIcon ([NullAllowed] string cPath, NSNumber nPage, PSPDFFormElement formElement, NSObject argument);

		[Abstract]
		[Export ("buttonImportIcon:page:sourceForm:")]
		nint GetButtonImportIcon ([NullAllowed] string cPath, NSNumber nPage, PSPDFFormElement formElement);

		[Export ("launchURL:newFrame:__JS_EXPORT_AS__launchURL:")]
		void LaunchUrl (string cUrl, [NullAllowed] NSNumber bNewFrame, NSObject argument);
	...
	interface PSPDFNewPageConfiguration {
		...
		PSPDFNewPageConfiguration FromEmptyPageBuilder ([NullAllowed] Action<PSPDFNewPageConfigurationBuilder> builder);

		[Static]
		[Export ("newPageConfigurationWithTiledPattern:builderBlock:")]
		PSPDFNewPageConfiguration FromTiledPattern (NSString tiledPattern, [NullAllowed] Action<PSPDFNewPageConfigurationBuilder> builder);

		[Static]
		[Wrap ("FromTiledPattern (pattern.GetConstant (), builder)")]
		PSPDFNewPageConfiguration FromTiledPattern (PSPDFNewPagePattern pattern, [NullAllowed] Action<PSPDFNewPageConfigurationBuilder> builder);

		[Static]
		[Export ("newPageConfigurationWithDocument:sourcePageIndex:builderBlock:")]
		PSPDFNewPageConfiguration FromDocument (PSPDFDocument sourceDocument, nuint sourcePageIndex, [NullAllowed] Action<PSPDFNewPageConfigurationBuilder> builder);
		...
		[NullAllowed, Export ("tiledPattern")]
	...
	interface PSPDFProcessor {
		...
		[Static]
		[Export ("generatePDFFromConfiguration:securityOptions:outputFileURL:progressBlock:error:")]
		bool GeneratePdf (PSPDFProcessorConfiguration configuration, [NullAllowed] PSPDFDocumentSecurityOptions securityOptions, NSUrl fileUrl, [NullAllowed] PSPDFProgressHandler progressHandler, [NullAllowed] out NSError error);

		[Static]
		[Export ("generatePDFFromConfiguration:securityOptions:progressBlock:error:")]
		[return: NullAllowed]
		NSData GeneratePdf (PSPDFProcessorConfiguration configuration, [NullAllowed] PSPDFDocumentSecurityOptions securityOptions, [NullAllowed] PSPDFProgressHandler progressHandler, [NullAllowed] out NSError error);

		[Static]
		[Export ("generatePDFFromConfiguration:securityOptions:outputDataSink:progressBlock:error:")]
		bool GeneratePdf (PSPDFProcessorConfiguration configuration, [NullAllowed] PSPDFDocumentSecurityOptions securityOptions, IPSPDFDataSink outputDataSink, [NullAllowed] PSPDFProgressHandler progressHandler, [NullAllowed] out NSError error);

#if __IOS__
		[Async]
		[Static]
		[Export ("generatePDFFromHTMLString:outputFileURL:options:completionBlock:")]
		void GeneratePdf (string html, NSUrl fileUrl, [NullAllowed] NSDictionary options, [NullAllowed] Action<NSError> completion);

		[Async]
		[Static]
		[Wrap ("GeneratePdf (html, fileUrl, generationOptions?.Dictionary, completion)")]
		void GeneratePdf (string html, NSUrl fileUrl, PSPDFProcessorGenerationOptions generationOptions, [NullAllowed] Action<NSError> completion);

		[Async]
		[Static]
		[Export ("generatePDFFromHTMLString:options:completionBlock:")]
		void GeneratePdf (string html, [NullAllowed] NSDictionary options, [NullAllowed] Action<NSData, NSError> completion);

		[Async]
		[Static]
		[Wrap ("GeneratePdf (html, generationOptions?.Dictionary, completion)")]
		void GeneratePdf (string html, PSPDFProcessorGenerationOptions generationOptions, [NullAllowed] Action<NSData, NSError> completion);

		[Async]
		[Static]
		[Export ("generatePDFFromURL:outputFileURL:options:completionBlock:")]
		[return: NullAllowed]
		PSPDFConversionOperation GeneratePdf (NSUrl inputUrl, NSUrl outputUrl, [NullAllowed] NSDictionary options, [NullAllowed] Action<NSUrl, NSError> completion);

		[Async]
		[Static]
		[Wrap ("GeneratePdf (inputUrl, outputUrl, generationOptions?.Dictionary, completion)")]
		[return: NullAllowed]
		PSPDFConversionOperation GeneratePdf (NSUrl inputUrl, NSUrl outputUrl, PSPDFProcessorGenerationOptions generationOptions, [NullAllowed] Action<NSUrl, NSError> completion);

		[Async]
		[Static]
		[Export ("generatePDFFromURL:options:completionBlock:")]
		PSPDFConversionOperation GeneratePdf (NSUrl inputUrl, [NullAllowed] NSDictionary options, [NullAllowed] Action<NSData, NSError> completion);

		[Async]
		[Static]
		[Wrap ("GeneratePdf (inputUrl, generationOptions?.Dictionary, completion)")]
		PSPDFConversionOperation GeneratePdf (NSUrl inputUrl, PSPDFProcessorGenerationOptions generationOptions, [NullAllowed] Action<NSData, NSError> completion);
#endif
	}
#if __IOS__
	[Static]
	...
	interface PSPDFPageRenderer {
		...
		[Field ("PSPDFRenderManagerRenderResultDidChangeNotification", PSPDFKitLibraryPath.LibraryPath)]
		[Notification (typeof (PSPDFRenderManagerRenderResultDidChangeNotificationEventArgs))]
		NSString RenderResultDidChangeNotification { get; }

		[Abstract]
		[Export ("drawPageIndex:inContext:documentProvider:withOptions:error:")]
		bool DrawPageIndex (nuint pageIndex, CGContext context, PSPDFDocumentProvider documentProvider, [NullAllowed] NSDictionary options, [NullAllowed] out NSError error);

		[Abstract]
		[Export ("renderAppearanceStream:inContext:withOptions:error:")]
		bool RenderAppearanceStream (PSPDFAnnotation annotation, CGContext context, [NullAllowed] NSDictionary options, [NullAllowed] out NSError error);
	}
	...
	interface PSPDFTextFieldFormElement {
		...
		[return: NullAllowed]
		string GetTextFieldChanged (string contents, string change, NSRange range, bool isFinal, [NullAllowed] IPSPDFApplicationJSExport application, [NullAllowed] out NSError validationError);
