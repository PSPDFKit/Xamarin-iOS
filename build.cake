...
var IOS_SERVICERELEASE_VERSION = "2"; // This is combined with the IOSVERSION variable for the NuGet Package version
	...
	.Does (() =>
{
	...
	var modelPackage = "./nuget/pkgs/PSPDFKit.iOS.Model." + IOSVERSION + $".{IOS_SERVICERELEASE_VERSION}.nupkg";
	var uiPackage = "./nuget/pkgs/PSPDFKit.iOS.UI." + IOSVERSION + $".{IOS_SERVICERELEASE_VERSION}.nupkg";
	var instantPackage = "./nuget/pkgs/PSPDFKit.iOS.Instant." + IOSVERSION + $".{IOS_SERVICERELEASE_VERSION}.nupkg";
	var macModelPackage = "./nuget/pkgs/PSPDFKit.Mac.Model." + MACVERSION + $"{MACOS_SERVICERELEASE_VERSION}.nupkg";
