...
namespace PSPDFKit.UI {
	...
	[BaseType (typeof (PSPDFSearchableTableViewController))]
	interface PSPDFOutlineViewController : PSPDFDocumentInfoController, IUISearchDisplayDelegate, PSPDFStyleable, IPSPDFOverridable {
	...
	[BaseType (typeof (PSPDFBaseTableViewController))]
	interface PSPDFSearchViewController : IUISearchDisplayDelegate, IUISearchBarDelegate, IPSPDFTextSearchDelegate, PSPDFStyleable, IPSPDFOverridable {
	...
	[Obsolete ("Please consider creating your own segmented control subclass.")]
