...
- Xamarin.iOS Bindings for PSPDFKit 9.0.2 for iOS
...
2. Replacig `COCOAPODS_KEY` with your key go and download the following two zip files.
	- https://customers.pspdfkit.com/cocoapods/COCOAPODS_KEY/pspdfkit/9.0.2.zip
	- https://customers.pspdfkit.com/cocoapods/COCOAPODS_KEY/instant/9.0.2.zip
